...
\emph{Integrated services}\todo{citations} (IntServ) and \emph{Differentiated services}\todo{citations} (DiffServ)
...
FlowQos\todo{citations} is a framework that utilizes SDN to reconfigure home routers according to a set of rate shaping
...
flow-based QoS management framework\todo{citations} that separate flow table to three different tables: flow state table, forwarding
...
not designed for home networks. OpenQoS\todo{citations} proposed a novel controller design for QoS routing where the routes of
