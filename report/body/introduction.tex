...
This paper presents several contributions. First, when we design the specification language, we take into account that the QoS requirement for an application may change in different scenarios. Second, we design and implement
...
\refsect{related} presents the related work in QoS, including traditional QoS strategies and SDN enabled technologies.
\refsect{qosmanager} describes the design of our approach, especially the dynamic queue assignment algorithm.
\refsect{experiment} evaluates our approach in the context of competing flows. \refsect{future} discusses future work
and concludes.
