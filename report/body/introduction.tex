...
computation resources. Therefore, they may not be able to process and enforce complicated QoS requirements
...
QoSManger provides an interface for modifying QoS requirements at runtime (configurable) and recompute the assignments
