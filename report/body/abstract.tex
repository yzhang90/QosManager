\begin{abstract}
In broadband access networks (e.g., home networks), bandwidths are limited. In the meanwhile,
...
\emph{QoSManager}, a configurable and adaptive QoS management framework where users
